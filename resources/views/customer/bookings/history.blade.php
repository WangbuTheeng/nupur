    ...
    <div class="bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="text-center">
                <h1 class="text-4xl font-bold mb-4">Travel History</h1>
                <p class="text-xl text-purple-100 max-w-2xl mx-auto">
                    Your completed journeys and past bookings
                </p>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            @foreach($booking->seat_numbers as $seatNumber)
                                                <span class="bg-purple-100 text-purple-800 px-3 py-1 rounded-lg text-sm font-medium">
                                                    {{ $seatNumber }}
                                                </span>
                                            @endforeach
                                        </div>
                                    ...
                                    <div class="flex flex-col sm:flex-row lg:flex-col space-y-3 sm:space-y-0 sm:space-x-3 lg:space-x-0 lg:space-y-3">
                                        ...
                                        @if($booking->status === 'confirmed')
                                            <a href="{{ route('customer.tickets.show', $booking) }}" 
                                               class="bg-purple-600 text-white px-6 py-3 rounded-xl hover:bg-purple-700 text-sm font-semibold transition-colors text-center">
                                                View Ticket
                                            </a>
                                        @endif
                                    </div>
        ...
        @else
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 p-12 text-center">
                <div class="max-w-md mx-auto">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 mb-4">No Travel History</h3>
                    <p class="text-gray-600 mb-8">You haven't completed any trips yet. Your past journeys will appear here.</p>
                    <a href="{{ route('search.index') }}" 
                       class="inline-flex items-center px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 font-semibold transition-colors">
