        ...
        <div class="px-6 py-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="text-gray-600">Manage customer accounts and view booking history</p>
                </div>
                <div class="mt-4 sm:mt-0 flex space-x-3">
                    ...
                    <a href="{{ route('admin.users.export', request()->query()) }}" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-xl border border-gray-100">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Active Bookers</dt>
                            <dd class="text-2xl font-bold text-gray-900">{{ $stats['active_bookings'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow-lg rounded-xl mb-6 border border-gray-100">
        <div class="p-6">
            <form method="GET" action="{{ route('admin.users.index') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div>
                    <label for="booking_activity" class="block text-sm font-medium text-gray-700 mb-2">Booking Activity</label>
                    <select name="booking_activity" id="booking_activity" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                        <option value="">All Users</option>
                        <option value="active" {{ request('booking_activity') === 'active' ? 'selected' : '' }}>Active Bookers</option>
                        <option value="inactive" {{ request('booking_activity') === 'inactive' ? 'selected' : '' }}>Inactive Bookers</option>
                    </select>
                </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        @if($user->bookings_count > 0)
                                            Last: {{ $user->bookings()->latest()->first()?->created_at?->diffForHumans() ?? 'N/A' }}
                                        @else
                                            No bookings yet
                                        @endif
                                    </div>
